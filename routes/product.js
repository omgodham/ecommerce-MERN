...
const {getProductById,createProduct,getAllProducts,getPhoto,getProduct,updateProduct,deleteProduct,getProductsByCategory,getProductsByCategoryAndSubcategory,getProductsBySubCategory} = require('../controllers/product');
